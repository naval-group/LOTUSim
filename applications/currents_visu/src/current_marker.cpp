...
public:
    CubeSubPub() : Node("cube_sub_pub"), int_id(0)
    {
        pose_subscription = this->create_subscription<geometry_msgs::msg::Pose>(
            "/cube_currents",
            100,
            std::bind(&CubeSubPub::pose_callback, this, std::placeholders::_1));
        marker_publisher =
            this->create_publisher<visualization_msgs::msg::Marker>(
                "arrow_currents_marker",
                100);
    }
...
private:
    ...
    void pose_callback(const geometry_msgs::msg::Pose::SharedPtr msg)
    {
        RCLCPP_INFO(
            this->get_logger(),
            "Received current: [U:%.2f, V:%.2f, W:%.2f]",
            msg->orientation.x,
            msg->orientation.y,
            msg->orientation.z);
        ...
        // Convert the time_point to a duration in milliseconds (or any other
        // desired unit)
        ...
        RCLCPP_INFO(
            this->get_logger(),
            "Publishing corresponding arrow marker in RViz...");
    }
