...
private:
    void pose_callback(const geometry_msgs::msg::Pose::SharedPtr msg)
    {
        ...
        // unique ID Any marker sent with the same namespace and id will
        // overwrite the old one
        marker.ns = "basic_shapes";
        marker.id = 0;

        // Set the marker type
        // Initially this is CUBE, and cycles between that and SPHERE, ARROW,
        // and CYLINDER
        ...
        std::string package_share_directory =
            ament_index_cpp::get_package_share_directory("currents_visu");
        marker.mesh_resource =
            "file://" + package_share_directory + "/meshes/tethys.dae";
        ...
        RCLCPP_INFO(
            this->get_logger(),
            "Publishing corresponding object marker in RViz...");
    }
