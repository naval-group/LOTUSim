...
template <>
void convert_ros_to_gz(
    const ros_gz_interfaces::msg::Light &ros_msg, ignition::msgs::Light &gz_msg)
{
    convert_ros_to_gz(ros_msg.header, (*gz_msg.mutable_header()));
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::Light &gz_msg, ros_gz_interfaces::msg::Light &ros_msg)
{
    convert_gz_to_ros(gz_msg.header(), ros_msg.header);
    ...
    ignition::msgs::WorldControl &gz_msg)
{
    ...
    convert_ros_to_gz(
        ros_msg.run_to_sim_time, *gz_msg.mutable_run_to_sim_time());
}
