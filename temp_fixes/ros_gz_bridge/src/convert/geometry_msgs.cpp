...
template <>
void convert_ros_to_gz(
    const geometry_msgs::msg::Point &ros_msg, ignition::msgs::Vector3d &gz_msg)
{
    gz_msg.set_x(ros_msg.x);
    gz_msg.set_y(ros_msg.y);
    gz_msg.set_z(ros_msg.z);
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::Vector3d &gz_msg, geometry_msgs::msg::Point &ros_msg)
{
    ros_msg.x = gz_msg.x();
    ros_msg.y = gz_msg.y();
    ros_msg.z = gz_msg.z();
...
template <>
void convert_ros_to_gz(
    const geometry_msgs::msg::Pose &ros_msg, ignition::msgs::Pose &gz_msg)
{
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::Pose &gz_msg, geometry_msgs::msg::Pose &ros_msg)
{
...
{
    convert_ros_to_gz(
        ros_msg.pose.position, *gz_msg.mutable_pose()->mutable_position());
    convert_ros_to_gz(
        ros_msg.pose.orientation,
        *gz_msg.mutable_pose()->mutable_orientation());
...
template <>
void convert_ros_to_gz(
    const geometry_msgs::msg::Transform &ros_msg, ignition::msgs::Pose &gz_msg)
{
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::Pose &gz_msg, geometry_msgs::msg::Transform &ros_msg)
{
...
template <>
void convert_ros_to_gz(
    const geometry_msgs::msg::Twist &ros_msg, ignition::msgs::Twist &gz_msg)
{
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::Twist &gz_msg, geometry_msgs::msg::Twist &ros_msg)
{
...
{
    convert_ros_to_gz(
        ros_msg.twist.linear, (*gz_msg.mutable_twist()->mutable_linear()));
    convert_ros_to_gz(
        ros_msg.twist.angular, (*gz_msg.mutable_twist()->mutable_angular()));
    for (const auto &elem : ros_msg.covariance) {
        gz_msg.mutable_covariance()->add_data(elem);
    }
}
...
template <>
void convert_ros_to_gz(
    const geometry_msgs::msg::Wrench &ros_msg, ignition::msgs::Wrench &gz_msg)
{
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::Wrench &gz_msg, geometry_msgs::msg::Wrench &ros_msg)
{
