    ...
    const sensor_msgs::msg::Image &ros_msg, gz::msgs::Image &gz_msg)
{
  ...
  unsigned int octets_per_channel;
    ...
    if (ros_msg.encoding == "mono8") {
        ...
        std::cerr << "Unsupported pixel format [" << ros_msg.encoding << "]"
                  << std::endl;
        return;
    }
    ...
    const gz::msgs::Image &gz_msg, sensor_msgs::msg::Image &ros_msg)
{
  ...
  unsigned int octets_per_channel;
    ...
    if (gz_msg.pixel_format_type() == gz::msgs::PixelFormatType::L_INT8) {
        ...
        gz_msg.pixel_format_type() == gz::msgs::PixelFormatType::RGB_INT8) {
        ros_msg.encoding = "rgb8";
        num_channels = 3;
        octets_per_channel = 1u;
    }
    else if (
        gz_msg.pixel_format_type() == gz::msgs::PixelFormatType::RGBA_INT8) {
        ros_msg.encoding = "rgba8";
        num_channels = 4;
        octets_per_channel = 1u;
    }
    else if (
        gz_msg.pixel_format_type() == gz::msgs::PixelFormatType::BGRA_INT8) {
        ros_msg.encoding = "bgra8";
        num_channels = 4;
        octets_per_channel = 1u;
    }
    else if (
        gz_msg.pixel_format_type() == gz::msgs::PixelFormatType::RGB_INT16) {
        ros_msg.encoding = "rgb16";
        num_channels = 3;
        octets_per_channel = 2u;
    }
    else if (
        gz_msg.pixel_format_type() == gz::msgs::PixelFormatType::BGR_INT8) {
        ros_msg.encoding = "bgr8";
        num_channels = 3;
        octets_per_channel = 1u;
    }
    else if (
        gz_msg.pixel_format_type() == gz::msgs::PixelFormatType::BGR_INT16) {
        ros_msg.encoding = "bgr16";
        num_channels = 3;
        octets_per_channel = 2u;
    }
    else if (
        gz_msg.pixel_format_type() == gz::msgs::PixelFormatType::R_FLOAT32) {
        ros_msg.encoding = "32FC1";
        num_channels = 1;
        octets_per_channel = 4u;
    }
    else {
        std::cerr << "Unsupported pixel format [" << gz_msg.pixel_format_type()
                  << "]" << std::endl;
        return;
    }
  ...
  ros_msg.width = gz_msg.width();
    ...
    if (gz_msg.has_distortion()) {
        ...
        if (distortion.model() == gz::msgs::CameraInfo::Distortion::PLUMB_BOB) {
            ...
            std::cerr << "Unsupported distortion model [" << distortion.model()
                      << "]" << std::endl;
        }
    ...
    const sensor_msgs::msg::Imu &ros_msg, gz::msgs::IMU &gz_msg)
{
  ...
  gz_msg.set_entity_name(ros_msg.header.frame_id);
    ...
    convert_ros_to_gz(
        ros_msg.angular_velocity, (*gz_msg.mutable_angular_velocity()));
    convert_ros_to_gz(
        ros_msg.linear_acceleration, (*gz_msg.mutable_linear_acceleration()));
...
template <>
void convert_ros_to_gz(
    const sensor_msgs::msg::JointState &ros_msg, gz::msgs::Model &gz_msg)
{
    convert_ros_to_gz(ros_msg.header, (*gz_msg.mutable_header()));
...
template <>
void convert_ros_to_gz(
    const sensor_msgs::msg::Joy &ros_msg, gz::msgs::Joy &gz_msg)
{
    convert_ros_to_gz(ros_msg.header, (*gz_msg.mutable_header()));
...
template <>
void convert_gz_to_ros(
    const gz::msgs::Joy &gz_msg, sensor_msgs::msg::Joy &ros_msg)
{
    convert_gz_to_ros(gz_msg.header(), ros_msg.header);
...
template <>
void convert_ros_to_gz(
    const sensor_msgs::msg::LaserScan &ros_msg, gz::msgs::LaserScan &gz_msg)
{
    ...
    sensor_msgs::msg::BatteryState &ros_msg)
{
  ...
  ros_msg.percentage = gz_msg.percentage();
    ...
    if (gz_msg.power_supply_status() == gz::msgs::BatteryState::UNKNOWN) {
        ...
        gz_msg.power_supply_status() == gz::msgs::BatteryState::DISCHARGING) {
        ros_msg.power_supply_status =
            sensor_msgs::msg::BatteryState::POWER_SUPPLY_STATUS_DISCHARGING;
    }
    else if (
        gz_msg.power_supply_status() == gz::msgs::BatteryState::NOT_CHARGING) {
        ros_msg.power_supply_status =
