...
template <>
void convert_ros_to_gz(
    const sensor_msgs::msg::Image &ros_msg, ignition::msgs::Image &gz_msg)
{
    convert_ros_to_gz(ros_msg.header, (*gz_msg.mutable_header()));
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::Image &gz_msg, sensor_msgs::msg::Image &ros_msg)
{
    convert_gz_to_ros(gz_msg.header(), ros_msg.header);
...
template <>
void convert_ros_to_gz(
    const sensor_msgs::msg::Imu &ros_msg, ignition::msgs::IMU &gz_msg)
{
    convert_ros_to_gz(ros_msg.header, (*gz_msg.mutable_header()));
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::IMU &gz_msg, sensor_msgs::msg::Imu &ros_msg)
{
    convert_gz_to_ros(gz_msg.header(), ros_msg.header);
...
template <>
void convert_ros_to_gz(
    const sensor_msgs::msg::JointState &ros_msg, ignition::msgs::Model &gz_msg)
{
    convert_ros_to_gz(ros_msg.header, (*gz_msg.mutable_header()));
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::Model &gz_msg, sensor_msgs::msg::JointState &ros_msg)
{
    convert_gz_to_ros(gz_msg.header(), ros_msg.header);
...
template <>
void convert_ros_to_gz(
    const sensor_msgs::msg::NavSatFix &ros_msg, ignition::msgs::NavSat &gz_msg)
{
    convert_ros_to_gz(ros_msg.header, (*gz_msg.mutable_header()));
...
template <>
void convert_gz_to_ros(
    const ignition::msgs::NavSat &gz_msg, sensor_msgs::msg::NavSatFix &ros_msg)
{
    convert_gz_to_ros(gz_msg.header(), ros_msg.header);
    ...
    ignition::msgs::BatteryState &gz_msg)
{
    ...
    case sensor_msgs::msg::BatteryState::POWER_SUPPLY_STATUS_DISCHARGING:
        gz_msg.set_power_supply_status(
    ...
    sensor_msgs::msg::BatteryState &ros_msg)
{
    ...
    if (gz_msg.power_supply_status() == ignition::msgs::BatteryState::UNKNOWN) {
        ...
        gz_msg.power_supply_status() == ignition::msgs::BatteryState::FULL) {
        ros_msg.power_supply_status =
