...
void createTestMsg(std_msgs::msg::Bool &_msg) { _msg.data = true; }
...
void createTestMsg(std_msgs::msg::Float32 &_msg) { _msg.data = 1.5; }
...
void createTestMsg(std_msgs::msg::Float64 &_msg) { _msg.data = 1.5; }
...
void createTestMsg(std_msgs::msg::Int32 &_msg) { _msg.data = -10; }
...
void createTestMsg(std_msgs::msg::UInt32 &_msg) { _msg.data = 1; }
...
void createTestMsg(std_msgs::msg::String &_msg) { _msg.data = "string"; }
    ...
    const std::shared_ptr<ros_gz_interfaces::msg::ParamVec> &_msg)
{
    ...
    if (_msg->params[0].name.find("param_0") != std::string::npos) {
        EXPECT_EQ(
            "param_0/" + expected_msg.params[0].name, _msg->params[0].name);
    }
    else {
...
void compareTestMsg(const std::shared_ptr<sensor_msgs::msg::NavSatFix> &_msg)
{
    ...
    EXPECT_EQ(
        expected_msg.position_covariance_type, _msg->position_covariance_type);
    ...
    const std::shared_ptr<trajectory_msgs::msg::JointTrajectoryPoint> &_msg)
{
    ...
    EXPECT_EQ(
        expected_msg.time_from_start.nanosec, _msg->time_from_start.nanosec);
}
