...
{
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->translation));
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Quaternion>(_msg->rotation));
}
    ...
    const std::shared_ptr<geometry_msgs::msg::TransformStamped> &_msg)
{
    ...
    compareTestMsg(_msg->header);
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Transform>(_msg->transform));
...
void compareTestMsg(const std::shared_ptr<tf2_msgs::msg::TFMessage> &_msg)
{
    ...
    compareTestMsg(std::make_shared<geometry_msgs::msg::TransformStamped>(
        _msg->transforms[0]));
}
...
void compareTestMsg(const std::shared_ptr<geometry_msgs::msg::Twist> &_msg)
{
    ...
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->angular));
}
...
void compareTestMsg(
    const std::shared_ptr<geometry_msgs::msg::TwistStamped> &_msg)
{
...
{
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->twist.linear));
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->twist.angular));
    for (int i = 0; i < 36; i++) {
        EXPECT_EQ(_msg->covariance[i], i);
    }
}
...
void compareTestMsg(
    const std::shared_ptr<geometry_msgs::msg::TwistWithCovarianceStamped> &_msg)
{
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::TwistWithCovariance>(_msg->twist));
    compareTestMsg(std::make_shared<std_msgs::msg::Header>(_msg->header));
}
...
void compareTestMsg(
    const std::shared_ptr<geometry_msgs::msg::WrenchStamped> &_msg)
{
    compareTestMsg(std::make_shared<std_msgs::msg::Header>(_msg->header));
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->wrench.force));
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->wrench.torque));
}
...
void createTestMsg(gps_msgs::msg::GPSFix &_msg)
{
    ...
    _msg.position_covariance_type =
        gps_msgs::msg::GPSFix::COVARIANCE_TYPE_UNKNOWN;
}
...
void compareTestMsg(const std::shared_ptr<gps_msgs::msg::GPSFix> &_msg)
{
    ...
    EXPECT_EQ(
        expected_msg.position_covariance_type,
        _msg->position_covariance_type);
...
void compareTestMsg(const std::shared_ptr<ros_gz_interfaces::msg::Light> &_msg)
{
    ...
    EXPECT_FLOAT_EQ(
        expected_msg.attenuation_constant,
        _msg->attenuation_constant);
    EXPECT_FLOAT_EQ(expected_msg.attenuation_linear, _msg->attenuation_linear);
    EXPECT_FLOAT_EQ(
        expected_msg.attenuation_quadratic,
        _msg->attenuation_quadratic);
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->direction));
...
void compareTestMsg(
    const std::shared_ptr<ros_gz_interfaces::msg::MaterialColor> &_msg)
{
    ...
    compareTestMsg(_msg->header);
    compareTestMsg(
        std::make_shared<ros_gz_interfaces::msg::Entity>(_msg->entity));
    ...
    const std::shared_ptr<ros_gz_interfaces::msg::GuiCamera> &_msg)
{
    ...
    compareTestMsg(_msg->header);
    compareTestMsg(
        std::make_shared<ros_gz_interfaces::msg::TrackVisual>(_msg->track));
    compareTestMsg(std::make_shared<geometry_msgs::msg::Pose>(_msg->pose));
    ...
    const std::shared_ptr<ros_gz_interfaces::msg::ParamVec> &_msg)
{
    ...
    if (_msg->params[0].name.find("param_0") != std::string::npos) {
        EXPECT_EQ(
            "param_0/" + expected_msg.params[0].name,
            _msg->params[0].name);
    } else {
    ...
    EXPECT_EQ(
        expected_msg.params[0].value.string_value,
        _msg->params[0].value.string_value);
}
...
void compareTestMsg(
    const std::shared_ptr<ros_gz_interfaces::msg::SensorNoise> &_msg)
{
    ...
    const std::shared_ptr<ros_gz_interfaces::msg::JointWrench> &_msg)
{
    ...
    compareTestMsg(_msg->header);
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Wrench>(_msg->body_1_wrench));
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Wrench>(_msg->body_2_wrench));
}
...
void compareTestMsg(
    const std::shared_ptr<ros_gz_interfaces::msg::Altimeter> &_msg)
{
    ...
    const std::shared_ptr<ros_gz_interfaces::msg::Contact> &_msg)
{
    ...
    createTestMsg(expected_msg);
    compareTestMsg(
        std::make_shared<ros_gz_interfaces::msg::Entity>(_msg->collision1));
    compareTestMsg(
        std::make_shared<ros_gz_interfaces::msg::Entity>(_msg->collision2));
    ...
    for (size_t i = 0; i < _msg->depths.size(); i++) {
        ...
        compareTestMsg(std::make_shared<geometry_msgs::msg::Vector3>(
            _msg->positions.at(i)));
        compareTestMsg(
            std::make_shared<geometry_msgs::msg::Vector3>(_msg->normals.at(i)));
        compareTestMsg(std::make_shared<ros_gz_interfaces::msg::JointWrench>(
            _msg->wrenches.at(i)));
    }
}
    ...
    const std::shared_ptr<ros_gz_interfaces::msg::Contacts> &_msg)
{
    ...
    for (size_t i = 0; i < _msg->contacts.size(); i++) {
        compareTestMsg(std::make_shared<ros_gz_interfaces::msg::Contact>(
            _msg->contacts.at(i)));
    }
}
...
void compareTestMsg(const std::shared_ptr<nav_msgs::msg::Odometry> &_msg)
{
    ...
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Twist>(_msg->twist.twist));
}
...
void compareTestMsg(const std::shared_ptr<sensor_msgs::msg::Imu> &_msg)
{
    ...
    compareTestMsg(_msg->orientation);
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->angular_velocity));
    compareTestMsg(std::make_shared<geometry_msgs::msg::Vector3>(
    ...
    const std::shared_ptr<sensor_msgs::msg::MagneticField> &_msg)
{
    compareTestMsg(_msg->header);
    compareTestMsg(
        std::make_shared<geometry_msgs::msg::Vector3>(_msg->magnetic_field));
}
    ...
    const std::shared_ptr<trajectory_msgs::msg::JointTrajectoryPoint> &_msg)
{
    ...
    EXPECT_EQ(
        expected_msg.time_from_start.nanosec,
        _msg->time_from_start.nanosec);
}
    ...
    const std::shared_ptr<trajectory_msgs::msg::JointTrajectory> &_msg)
{
    ...
    for (auto i = 0u; i < _msg->points.size(); ++i) {
        compareTestMsg(
            std::make_shared<trajectory_msgs::msg::JointTrajectoryPoint>(
                _msg->points[i]));
    }
}
...
void compareTestMsg(const std::shared_ptr<vision_msgs::msg::Detection2D> &_msg)
{
    ...
    for (size_t i = 0; i < _msg->results.size(); i++) {
        EXPECT_EQ(
            expected_msg.results[i].hypothesis.class_id,
            _msg->results[i].hypothesis.class_id);
        EXPECT_EQ(
            expected_msg.results[i].hypothesis.score,
            _msg->results[i].hypothesis.score);
    }
    EXPECT_EQ(expected_msg.bbox.size_x, _msg->bbox.size_x);
    EXPECT_EQ(expected_msg.bbox.size_y, _msg->bbox.size_y);
    EXPECT_EQ(
        expected_msg.bbox.center.position.x,
        _msg->bbox.center.position.x);
    EXPECT_EQ(
        expected_msg.bbox.center.position.y,
        _msg->bbox.center.position.y);
}
...
void compareTestMsg(
    const std::shared_ptr<vision_msgs::msg::Detection2DArray> &_msg)
{
    ...
    for (size_t i = 0; i < _msg->detections.size(); i++) {
        compareTestMsg(std::make_shared<vision_msgs::msg::Detection2D>(
            _msg->detections[i]));
    }
}
...
void compareTestMsg(const std::shared_ptr<vision_msgs::msg::Detection3D> &_msg)
{
    ...
    EXPECT_EQ(
        ...
        _msg->bbox.center.position.y);
    EXPECT_EQ(
        expected_msg.bbox.center.position.z,
        _msg->bbox.center.position.z);
    EXPECT_EQ(
        expected_msg.bbox.center.orientation.x,
        _msg->bbox.center.orientation.x);
    EXPECT_EQ(
        expected_msg.bbox.center.orientation.y,
        _msg->bbox.center.orientation.y);
    EXPECT_EQ(
        expected_msg.bbox.center.orientation.z,
        _msg->bbox.center.orientation.z);
    EXPECT_EQ(
        expected_msg.bbox.center.orientation.w,
        _msg->bbox.center.orientation.w);
}
...
void compareTestMsg(
    const std::shared_ptr<vision_msgs::msg::Detection3DArray> &_msg)
{
    ...
    EXPECT_EQ(expected_msg.detections.size(), _msg->detections.size());
    for (size_t i = 0; i < _msg->detections.size(); i++) {
        compareTestMsg(std::make_shared<vision_msgs::msg::Detection3D>(
            _msg->detections[i]));
    }
}
