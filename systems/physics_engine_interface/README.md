...
**Coordinate conversion:** xdyn communicates in NED with velocities expressed in body frame; Gazebo uses ENU with world velocities. Class `VesselInformation` is used to perform conversion.
