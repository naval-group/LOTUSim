...
// Speed when propeller are spawned
constexpr unsigned short DEFAULT_RPM = 0.0;
...
public:
    TcpUdpInterface(std::shared_ptr<spdlog::logger> logger);
    ~TcpUdpInterface();
...
private:
     ...
     * Used to animate the propeller spinning
     *
     */
