...
CustomSensor::CustomSensor() : m_Namespace("")
{
    ...
    // Try to get a sensor logger. If this does not exist. We will create a
    // logger
    m_logger = logger::getLogger("custom_sensor");
    if (m_logger) {
