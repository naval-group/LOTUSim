...
bool AgentEntity::spawn(){
    ...
    entity_management_client_node->create_client<liquidai_msgs::srv::AddEntity>("/gz_add_entity");
...
bool AgentEntity::despawn(){
    ...
    rclcpp::Client<liquidai_msgs::srv::RemoveEntity>::SharedPtr client =
        entity_management_client_node->create_client<liquidai_msgs::srv::RemoveEntity>("/gz_remove_entity");

    auto request = std::make_shared<liquidai_msgs::srv::RemoveEntity::Request>();
