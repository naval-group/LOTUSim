...
def main():
    ...
    request.sdf = sdf_file_path

    print("SDF File Path: " + sdf_file_path)
    print("robot_name: " + args.robot_name)

    # node.create_service(_ENTITY_TYPE, "/world/demo/create", create_entity_callback)
...
def add_model(model):
    ...
    command = [
        ...
        "--timeout", "5000",
        "--req",
        'name: "test"; sdf_filename: "diff_drive/model.sdf"; pose: {position: {x: 10, y: 10, z: 0}, orientation: {x: 0, y: 0, z: 0.7071, w: 0.7071}}'
    ]
